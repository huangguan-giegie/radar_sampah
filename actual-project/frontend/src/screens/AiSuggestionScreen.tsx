...
export default function AiSuggestionScreen() {
  ...
  useEffect(() => {
    ...
    analyseReportPhoto(photoKey, params.get('ai') === 'fail')
      .then((result) => patchDraft({ itemCounts: result.counts, aiModelState: result.modelState, aiModelVersion: result.modelVersion, aiDecision: null, quantities: {} }))
      .catch(() => patchDraft({ itemCounts: {}, aiModelState: 'unavailable', aiModelVersion: null, aiDecision: null, quantities: {} }))
  ...
  return (
    <div className="screen" style={{ zIndex: 27 }}>
      ...
      <div className="measure i2-page anim-fade-up" style={{ minHeight: '70vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
        ...
        <p className="i2-subtitle">We’ll prefill exact item counts before you review what you found.</p>
