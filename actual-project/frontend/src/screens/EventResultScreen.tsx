      ...
      <div className="measure i2-page anim-fade-up" style={{ paddingBottom: 'calc(var(--safe-bottom) + 34px)' }}>
        ...
        {cleanups.length === 0 ? (
          ...
          <div className="i2-card">
            <SectionLabel size="sm">CLEANED ITEMS</SectionLabel>
        ...
        <Callout title="Recorded evidence only" tone="quiet" icon={<Info color={C.navy} />}>
          These totals are confirmed item counts. They are not a moderator verification, environmental-impact score or proof that the beach is clean.
        </Callout>
